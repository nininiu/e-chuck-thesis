...
%NOTE:
%  ``stepper'': the stepper motor part
%  ``zaber''  : the home sensor part
...
\begin{figure}[tbhp]
\centering
\includegraphics[width=0.618\linewidth]{impl/pcb__stepper__dm422c.jpg}
...
\begin{figure}[tbhp]
\centering
\includegraphics[width=0.618\linewidth]{impl/pcb__stepper__max490.jpg}
...
\begin{figure}[tbhp]
\centering
\includegraphics[width=0.66\linewidth]{impl/pcb__zaber__opto__perf.png}
...
\begin{figure}[tbhp]
\centering
\includegraphics[height=0.35\textheight]{impl/pcb__zaber__emi__before.jpg}
